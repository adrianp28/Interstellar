...
public class Bullet extends GameFigure {
    ...
    private static final int UNIT_TRAVEL_DISTANCE = 40; // per frame move
    ...
    public void updateState() {
        if (state == GameFigureState.MISSILE_STATE_LAUNCHED) {
            ...
            boolean targetReached = (super.x <= 0 || super.x>= Main.WIN_WIDTH || super.y <=0 || super.y >= Main.WIN_HEIGHT);
            if (targetReached) {
